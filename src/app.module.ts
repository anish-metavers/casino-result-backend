...
import { Lucky7euModule } from './luckySevenCron/cron.module';
...
import { Poker20Module } from './pokerTwentyCron/cron.module';
import { PokerModule } from './pokerOneDayCron/cron.module';
import { Poker6Module } from './pokerSixCron/cron.module';
